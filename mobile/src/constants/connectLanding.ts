...
/** Primary CTA on Play landing — same label before/after Golf Dates opt-in. */
export const PLAY_LANDING_BUTTON = 'Play';

export const PLAY_PROFILE_CONNECT_BUTTON = 'Play ⛳';
