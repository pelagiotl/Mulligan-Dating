...
/** Web Connect CTA — fewer particles; mix of Discover People emojis (✨ 🎯 💝) and light hearts. */
const CONNECT_SHOOTING_SPECS: ShootingHeartSpec[] = [
  ...
  { emoji: '🎯', left: '24%', delayMs: 280, durationMs: 2400, startY: -42, endY: 30, driftX: -10, sizePx: 17, startRotationDeg: 12, endRotationDeg: -6 },
  { emoji: '💝', left: '40%', delayMs: 520, durationMs: 2000, startY: -38, endY: 36, driftX: 6, sizePx: 14, startRotationDeg: 0, endRotationDeg: 0 },
  { emoji: '💖', left: '56%', delayMs: 120, durationMs: 2600, startY: -44, endY: 32, driftX: -14, sizePx: 16, startRotationDeg: -8, endRotationDeg: 14 },
  { emoji: '✨', left: '72%', delayMs: 640, durationMs: 2300, startY: -40, endY: 35, driftX: 10, sizePx: 15, startRotationDeg: 16, endRotationDeg: -10 },
  { emoji: '💕', left: '88%', delayMs: 400, durationMs: 2100, startY: -34, endY: 38, driftX: -8, sizePx: 14, startRotationDeg: -12, endRotationDeg: 6 },
];
