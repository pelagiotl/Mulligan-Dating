    ...
    <div className="auth-page-enhanced native-app-screen age-gate-page">
      ...
      <div className="auth-card age-gate-card">
        <div className="age-gate-icon" aria-hidden="true">
          <span className="age-gate-icon-inner">18+</span>
        </div>
        <h1 className="auth-title age-gate-title">Age requirement</h1>
        <p className="age-gate-lead">Mulligan is for adults only.</p>
